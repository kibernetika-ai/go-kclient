...
// APIClient manages communication with the Kibernetika project, backend component API v0.2
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ServingApi = (*ServingApiService)(&c.common)
